...
My game plan is to get the form blocks all done first before jumping over to metal working. After the tip form block is done, the next steps will be:

1. Sanding to the 90 degree shapes.
2. Routing the radius along the edges
